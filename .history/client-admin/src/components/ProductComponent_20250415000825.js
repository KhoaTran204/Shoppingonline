...
class Product extends Component {
  ...
  render() {
    const { loading, products, curPage, noPages, itemSelected, showForm } =
      this.state;
        ...
        products.map((item) => {
          return (
            <tr key={item._id} onClick={() => this.trItemClick(item)}>
              ...
              <td>
                {item.cdate ? new Date(item.cdate).toLocaleString() : "N/A"}
              </td>
              <td>
      ...
      <div>
        ...
        {(showForm || itemSelected) && (
          <ProductDetail
            ...
            onClose={() =>
              this.setState({ showForm: false, itemSelected: null })
            }
          />
        )}
      </div>
